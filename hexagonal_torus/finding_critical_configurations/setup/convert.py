...
def convert(pathname):
    ...
    with open(pathname, encoding='utf-8') as in_file:
        ...
        vars = re.findall(r'([xytv]\d+) = ', in_string)
        # print(vars)
        ...
        # Reduces arguments of v by 1. ADDED BY OZAN 10/28/2020
        in_string = re.sub(r'v\(1\)\;',r'v(0);',in_string)
        in_string = re.sub(r'v\(2\)\;',r'v(1);',in_string)

        ## Add arma::vec v. ADDED BY OZAN 10/28/2020
        in_string = re.sub(r'x1 = coords\(0\)\;',r'arma::vec v;\n\tx1 = coords(0);',in_string)
