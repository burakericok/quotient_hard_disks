...
%   config_ptil.m
%  
%   Purpose: constructs the permutaiton, translation, inversion and lattice
%   symmetries invariant configuration space (or quotient space). Embeds 
%   the points in the Euclidean space and constructs alpha-complex.
%
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% 
...
% alpha_filter = 0.2;    % choose from length scale analysis
