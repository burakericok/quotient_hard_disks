Calculates the descriptors in Eq. 6 and Eq. 7. Let $T$, $P$, $I$ and $L$ respectively denote the translations, permutations of disk labels, inversion and lattice symmetries. 

In 'generateDescriptors.m'
  Input:
