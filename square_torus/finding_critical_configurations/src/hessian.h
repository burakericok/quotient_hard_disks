...
//  hessian.h
//
//  Purpose:  declares a function to calculate the Hessian of the energy 
...
#ifndef GUARD_HESSIAN_H
#define GUARD_HESSIAN_H
...
arma::mat hessian(double, double, const arma::vec &, _periodic_x &, _periodic_y &);
