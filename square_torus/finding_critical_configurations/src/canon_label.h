...
//  canon_label.h
//
//  Purpose:  declares the function that interfaces with nauty to calculate the
...
#ifndef GUARD_CANON_LABEL_H
#define GUARD_CANON_LABEL_H
...
arma::umat canon_label(const arma::umat &, const arma::uvec &, arma::uvec &);
