...
//  jacobian.h
//
//  Purpose:  declares a function to find the gradient of the fictive energy
...
#ifndef GUARD_JACOBIAN_H
#define GUARD_JACOBIAN_H
...
arma::vec jacobian(double, double, const arma::vec &, _periodic_x &, _periodic_y &);
